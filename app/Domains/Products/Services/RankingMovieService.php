...
use App\Domains\Products\Repositories\RankingMovieRepository;

class RankingMovieService extends ServiceBase
{
    /**
     * @var $repository
     * @var $validator
     */
    protected $repository = RankingMovieRepository::class;
