...
use App\Domains\Products\Repositories\RankingRepository;
use App\Domains\Products\Validators\RankingValidator;
...
class RankingService extends ServiceBase
{
     ...
     * @var $validator
     */
    protected $repository = RankingRepository::class;
    protected $validator = RankingValidator::class;
